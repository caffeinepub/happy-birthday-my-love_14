...
import type { Slot as _Slot, SlotInfo as _SlotInfo, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createSlot(arg0: bigint, arg1: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createSlot(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSlotInfo(): Promise<Array<SlotInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSlotInfo();
    ...
    async getSlotByIndex(arg0: bigint): Promise<Slot | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSlotByIndex(arg0);
    ...
    async removeSlot(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_SlotInfo_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SlotInfo): SlotInfo {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Slot]): Slot | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SlotInfo>): Array<SlotInfo> {
    return value.map((x)=>from_candid_SlotInfo_n11(_uploadFile, _downloadFile, x));
}
